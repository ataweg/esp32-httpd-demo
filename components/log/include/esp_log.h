// --------------------------------------------------------------------------
//
// Project       IoT - Internet of Things - Iot-Wifi-Relay
//
// File          httpd-nonos.c
//
// Author        Axel Werner
...
#define ESP_LOG_LEVEL( level, tag, format, ... ) do {                     \
        if ( level==ESP_LOG_ERROR )          { esp_log_write( ESP_LOG_ERROR,      tag, LOG_FORMAT( E, "line %3d: " format ), esp_log_timestamp(), tag, __LINE__, ##__VA_ARGS__ ); } \
        else if ( level==ESP_LOG_WARN )      { esp_log_write( ESP_LOG_WARN,       tag, LOG_FORMAT( W, "line %3d: " format ), esp_log_timestamp(), tag, __LINE__, ##__VA_ARGS__ ); } \
        else if ( level==ESP_LOG_DEBUG )     { esp_log_write( ESP_LOG_DEBUG,      tag, LOG_FORMAT( D, "line %3d: " format ), esp_log_timestamp(), tag, __LINE__, ##__VA_ARGS__ ); } \
        else if ( level==ESP_LOG_VERBOSE )   { esp_log_write( ESP_LOG_VERBOSE,    tag, LOG_FORMAT( V, "line %3d: " format ), esp_log_timestamp(), tag, __LINE__, ##__VA_ARGS__ ); } \
        else                                { esp_log_write( ESP_LOG_INFO,       tag, LOG_FORMAT( I, "line %3d: " format ), esp_log_timestamp(), tag, __LINE__, ##__VA_ARGS__ ); } \
    } while( 0 )
